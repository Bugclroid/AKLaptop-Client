...
export default function AddContactPage() {
  ...
  async function handleSubmit(e) {
    ...
    setError('')
    try {
      await createContact({ name, type, phone, email, address, notes })
  ...
  return (
    <div className="max-w-xl p-4 sm:p-6">
      <h1 className="text-xl sm:text-2xl font-semibold mb-4">Add Contact</h1>
