  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl sm:text-2xl font-semibold text-white">Jobs</h1>
        <button onClick={() => navigate('/admin/add-job')} className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-3 py-2 rounded text-sm hover:bg-white/15 hover:border-white/30 transition-all duration-200 shadow-lg shadow-black/10">Create New Job</button>
      </div>
...
function StatCard({ label, value }){
  return (
    <div className="rounded-xl border border-white/20 bg-white/10 backdrop-blur-md p-3 sm:p-4 shadow-lg shadow-black/10 hover:bg-white/15 transition-all duration-200">
